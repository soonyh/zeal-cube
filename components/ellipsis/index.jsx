...
export default class Ellipsis extends Component {
  ...
  render() {
    ...
    const cls = classNames('cube-ellipsis', className, {
      [`cube-ellipsis-lines`]: lines && !isSupportLineClamp,
      [`cube-ellipsis-lineClamp`]: lines && isSupportLineClamp,
    });
    ...
    return (
      <div {...restProps} ref={this.handleRoot} className={cls}>
        <div ref={this.handleContent}>
          ...
          <div className='cube-ellipsis-shadow' ref={this.handleShadowChildren}>
            {children}
          </div>
          <div className='cube-ellipsis-shadow' ref={this.handleShadow}>
            <span>{text}</span>
          </div>
        </div>
      </div>
