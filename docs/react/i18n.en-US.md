...
zeal-cube provides a React Component [LocaleProvider](/components/locale-provider) for configuring antd locale text globally.

```jsx
import { LocaleProvider } from 'zeal-cube';
import frFR from 'zeal-cube/lib/locale-provider/fr_FR';
